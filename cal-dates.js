...
// Load up key dates for 2017-18
KEY_DATES['20170906'] = {isEarlyDismissal: false, hasNoSchool: false, description: "Start of school"};
KEY_DATES['20170911'] = {isEarlyDismissal: false, hasNoSchool: false, description: "Kindergarten starts"};
KEY_DATES['20171013'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Teach Profesional Development Day"};
KEY_DATES['20171110'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Veterans Day"};
KEY_DATES['20171120'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Elementary Conference Days - no school for K-8 students"};
KEY_DATES['20171121'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Elementary Conference Days - no school for K-8 students"};
KEY_DATES['20171122'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Elementary Conference Days - no school for K-8 students"};
KEY_DATES['20171123'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Thanksgiving Holiday"};
KEY_DATES['20171124'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Thanksgiving Holiday"};
KEY_DATES['20171215'] = {isEarlyDismissal: true, hasNoSchool: false, description: "1 hour early dismissal"};
KEY_DATES['20171218'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171219'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171220'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171221'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171222'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171223'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171224'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171225'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171226'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171227'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171228'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171229'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171230'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20171231'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Winter break"};
KEY_DATES['20180101'] = {isEarlyDismissal: false, hasNoSchool: true, description: "New Year's Day Observed"};
KEY_DATES['20180115'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Martin Luther King Jr. Day"};
KEY_DATES['20180131'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Day between semesters. No school"};
KEY_DATES['20180219'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Mid winter break"};
KEY_DATES['20180220'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Mid winter break"};
KEY_DATES['20180221'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Mid winter break"};
KEY_DATES['20180222'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Mid winter break"};
KEY_DATES['20180223'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Mid winter break"};
KEY_DATES['20180409'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Spring break"};
KEY_DATES['20180410'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Spring break"};
KEY_DATES['20180411'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Spring break"};
KEY_DATES['20180412'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Spring break"};
KEY_DATES['20180413'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Spring break"};
KEY_DATES['20180528'] = {isEarlyDismissal: false, hasNoSchool: true, description: "Memorial Day"};
KEY_DATES['20180622'] = {isEarlyDismissal: true, hasNoSchool: false, description: "Last day of schol. 1 hour early dismissal"};
